...
#define ANALYSIS_FLAGS "TAPP_OPTIONS"
#define commandline_flags get_flags()
...
extern test_flags *flags_dont_use;
...
public:
  virtual bool Parse(const char *value) { (void) value; return false; }
...
#define EXTERNC
#endif // __cplusplus
EXTERNC void InitializeTaPPFlags();

EXTERNC test_flags *get_flags();

EXTERNC void parseArgs(int argc, char** argv);
